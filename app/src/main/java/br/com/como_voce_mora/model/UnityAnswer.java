...
public enum UnityAnswer implements Serializable {
    ...
    LOCAL_PESSOAS_INTERESSAM("Local onde estão as pessoas que me interessam", "250bb5fd-966e-4d73-8902-e197de7bdc1b"),
    LOCAL_ATIVIDADES("Local no qual consigo realizar minhas atividades", "5f06efa4-7612-483a-9e07-78097e405240"),
    ...
    EASE_OF_FURNISHINGS_BATHROOM("Facilidade de mobiliar", "42a2ed79-9060-4eb0-b618-513d80178adb"),
    TEMPERATURE_BATHROOM("Temperatura", "f6edfc45-8e7b-4a50-be08-1d00c6501b46"),
    NATURAL_VENTILATION_BATHROOM("Nível de Convivência", "50deb47a-f668-4ed8-8a40-22c32a0dfca4"),
    NATURAL_ILUMINATION_BATHROOM("Iluminação natural", "423ef996-46f6-4c43-bea5-dc6fa390995f"),
    NOISE_LEVEL_BATHROOM("Nível de ruído", "4b0ffc5f-6e6a-45f1-b41f-4f6ff75e76d7"),
    SIZE_SATISFACTION_BATHROOM("Tamanho", "f3768d58-4924-4e48-a9d3-ea82a7ba79aa"),
