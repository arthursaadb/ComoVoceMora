...
public class PostDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_POSTS =
            "CREATE TABLE IF NOT EXISTS " + PostContract.PostEntry.TABLE_NAME + " (" +
    ...
    private static final String SQL_DELETE_POSTS = "DROP TABLE IF EXISTS " + PostContract.PostEntry.TABLE_NAME;
